...
def get_pdf_thumbnail(filename):
    ...
    return send_from_directory(COVERS_DIR, filename=thumbnail_path)
...
#     pdf_files = [f for f in os.listdir(PDF_DIR) if f.endswith('.pdf')]
#     
#     # Create a simple HTML template to display the list of books
#     html_template = '''
#     <!DOCTYPE html>
#     <html lang="en">
#     <head>
...
# @app.route('/files')
# def list_files():
#     directory_path = '/home/alvin/books'  # Replace with your directory path
